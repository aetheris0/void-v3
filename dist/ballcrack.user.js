...
.gui-button-container {\r
    user-select: none;\r
}`;function j(r){let e=document.createElement("style");e.textContent=r,d.wrapper.appendChild(e)}var q=new FontFace("Product Sans","url(https://fonts.gstatic.com/s/productsans/v19/pxiDypQkot1TnFhsFMOfGShVF9eO.woff2)",{style:"normal",weight:"400"});q.load().then(r=>document.fonts.add(r));var J=new FontFace("Inter","url(https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_fvQtMwCp50KnMa.woff2)",{style:"normal",weight:"300"});J.load().then(r=>document.fonts.add(r));j(V);function Y(){b.init(),a.hookOnTick(),f.init(),document.addEventListener("keydown",e=>{c.emit("keydown",e.code)}),setInterval(()=>{c.emit("render")},1e3/60),!0&&(window.ballcrack={hooks:a,shadowWrapper:d,moduleManager:b,interactionUtils:U,blockUtils:h,packetUtils:f})}document.readyState==="complete"||document.readyState==="interactive"?Y():document.addEventListener("DOMContentLoaded",Y);})();
