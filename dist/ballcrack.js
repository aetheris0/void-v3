...
.gui-button-container {\r
    user-select: none;\r
}`;var Y={init(){let r=a.game.player.inventory.sendInventoryToServer();this.$Message2=r.constructor.__proto__,this.proto2=r.constructor.runtime,this._toJson=this.$Message2.prototype.toJson;let e=this;this.$Message2.prototype.toJson=function(){let t=e._toJson.apply(this,arguments),o=this.getType().typeName;return p.emit("packet",{name:o,data:t}),t},this.PBFloatVector3=this.createPacket("PBFloatVector3",this.fields.PBFloatVector3),this.PBBlockPos=this.createPacket("PBBlockPos",this.fields.PBBlockPos),this.PBAction={0:"START_DESTROY_BLOCK",1:"ABORT_DESTROY_BLOCK",2:"STOP_DESTROY_BLOCK",3:"DROP_ALL_ITEMS",4:"DROP_ITEM",5:"RELEASE_USE_ITEM",START_DESTROY_BLOCK:0,ABORT_DESTROY_BLOCK:1,STOP_DESTROY_BLOCK:2,DROP_ALL_ITEMS:3,DROP_ITEM:4,RELEASE_USE_ITEM:5},this.proto2.util.setEnumType(this.PBAction,"PBAction",[{no:0,name:"START_DESTROY_BLOCK"},{no:1,name:"ABORT_DESTROY_BLOCK"},{no:2,name:"STOP_DESTROY_BLOCK"},{no:3,name:"DROP_ALL_ITEMS"},{no:4,name:"DROP_ITEM"},{no:5,name:"RELEASE_USE_ITEM"}]),this.PBEnumFacing={0:"UNDEFINED_FACE",1:"DOWN",2:"UP",3:"NORTH",4:"SOUTH",5:"WEST",6:"EAST",UNDEFINED_FACE:0,DOWN:1,UP:2,NORTH:3,SOUTH:4,WEST:5,EAST:6},this.proto2.util.setEnumType(this.PBEnumFacing,"PBEnumFacing",[{no:0,name:"UNDEFINED_FACE"},{no:1,name:"DOWN"},{no:2,name:"UP"},{no:3,name:"NORTH"},{no:4,name:"SOUTH"},{no:5,name:"WEST"},{no:6,name:"EAST"}])},createPacket(r,e=[],t={}){let o=this.$Message2,i=this.proto2,n=class extends o{constructor(l){super(),i.util.initPartial(l,this)}static fromBinary(l,u){return new n().fromBinary(l,u)}static fromJson(l,u){return new n().fromJson(l,u)}static fromJsonString(l,u){return new n().fromJsonString(l,u)}static equals(l,u){return i.util.equals(n,l,u)}};n.typeName=r,n.runtime=i,n.fields=i.util.newFieldList(()=>e);let s=new n;for(let l in t)s[l]=t[l];return s},sendPacket(r){let e=a.game.player,t=e.inventory.sendInventoryToServer,o=e.abilities.creative,i=e.inventory.main[e.inventory.currentItem];e.abilities.creative=!0,e.inventory.sendInventoryToServer=()=>r;try{a.game.controller.pickBlock.bind({getTargetedBlockState:function(){return b.fromBlockStateId(1)},findHotbarSlotForPickBlock:function(){return e.inventory.currentItem}})()}catch{}e.inventory.main[e.inventory.currentItem]=i,e.inventory.sendInventoryToServer=t,e.abilities.creative=o},fields:{PBFloatVector3:[{no:1,name:"x",kind:"scalar",T:2},{no:2,name:"y",kind:"scalar",T:2},{no:3,name:"z",kind:"scalar",T:2}],PBBlockPos:[{no:1,name:"x",kind:"scalar",T:17},{no:2,name:"y",kind:"scalar",T:17},{no:3,name:"z",kind:"scalar",T:17}]}};function Q(r){let e=document.createElement("style");e.textContent=r,d.wrapper.appendChild(e)}var Z=new FontFace("Product Sans","url(https://fonts.gstatic.com/s/productsans/v19/pxiDypQkot1TnFhsFMOfGShVF9eO.woff2)",{style:"normal",weight:"400"});Z.load().then(r=>document.fonts.add(r));var ee=new FontFace("Inter","url(https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_fvQtMwCp50KnMa.woff2)",{style:"normal",weight:"300"});ee.load().then(r=>document.fonts.add(r));Q(K);_.init();a.hookOnTick();Y.init();document.addEventListener("keydown",r=>{p.emit("keydown",r.code)});setInterval(()=>{p.emit("render")},1e3/60);var te=!0;te&&(window.ballcrack={hooks:a,shadowWrapper:d,moduleManager:_,interactionUtils:H,blockUtils:b,packetUtils:Y});})();
