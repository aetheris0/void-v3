(()=>{var p={listeners:{},activeKeys:new Set,on:function(o,e){this.listeners[o]||(this.listeners[o]=[]),this.listeners[o].push(e)},remove:function(o,e){this.listeners[o]&&(this.listeners[o]=this.listeners[o].filter(t=>t!==e))},emit:function(o,e){this.listeners[o]&&this.listeners[o].forEach(t=>t(e))},trackKey:function(o,e,t){o==="keydown"&&moduleManager.handleKeyPress(t),o==="keydown"&&!this.activeKeys.has(e)&&(this.activeKeys.add(e),this.emit("keyPress",{key:e,code:t})),o==="keyup"&&this.activeKeys.has(e)&&(this.activeKeys.delete(e),this.emit("keyRelease",{key:e,code:t}))}};var a={get game(){return this._game?this._game:this._game=Object.values(document.querySelector("#react"))[0].updateQueue.baseState.element.props.game},hookOnTick(){let o=this;this._fixedUpdate=this.game.fixedUpdate,this.game.fixedUpdate=function(){p.emit("beforeTick");let e=o._fixedUpdate.apply(this,arguments);return p.emit("afterTick"),e}}};var U={normalizeVector(o){let e=o.x*o.x+o.y*o.y+o.z*o.z;if(e>0){let t=1/Math.sqrt(e);return[o.x*t,o.y*t,o.z*t]}return o},distanceBetween(o,e){let t=e.x-o.x,r=e.y-o.y,i=e.z-o.z;return t*t+r*r+i*i},distanceBetweenSqrt(o,e){return Math.sqrt(this.distanceBetween(o,e))}};var l=class{constructor(e,t,r,i){this.name=e,this.category=t,this.options=r,this.keybind=i,this.waitingForBind=!1,this.isEnabled=!1,this.modes={},this.toggle=this.toggle.bind(this)}registerMode(e,t){this.modes[e]=t}onEnable(){}onDisable(){}onRender(){}beforeTick(){}afterTick(){}onSettingUpdate(){}onChunkAdded(){}onChunkRemoved(){}onGameEntered(){}onGameExited(){}onNoaTick(){}onPacket(e){}enable(){this.isEnabled=!0,p.emit("module.update",this),p.emit("module.toggle",{name:this.name,enabled:!0}),this.onEnable()}disable(){this.isEnabled=!1,p.emit("module.update",this),p.emit("module.toggle",{name:this.name,enabled:!1}),this.onDisable()}toggle(){this.isEnabled?this.disable():this.enable()}};var x=class extends l{constructor(){super("Killaura","Combat",{Delay:100,"Auto Block":"true"}),this.lastExecutionTime=null,this.blocking=!1}ignoreEntities=["EntityItem","EntityXPOrb"];afterTick(){let e=Date.now();e-this.lastExecutionTime>=this.options.Delay&&(this.lastExecutionTime=e,this.tryKill())}block(){a.game.controller.sendUseItem(a.game.player,a.game.world,a.game.player.inventory.getCurrentItem()),this.blocking=!0}unblock(){a.game.controller.onStoppedUsingItem(a.game.player),this.blocking=!1}tryKill(){let e=!1,t=ballcrack.hooks.game.player.inventory.getCurrentItem()?.item?.constructor?.name,r=this.options["Auto Block"]=="true";t!=="ItemSword"&&(r=!1),a.game.world.loadedEntityList.forEach(i=>{let n=U.distanceBetween(i.pos,a.game.player.pos);a.game.player.id!==i.id&&n<14&&!this.ignoreEntities.includes(i.constructor.name)&&(e=!0,r&&this.unblock(),a.game.controller.objectMouseOver.hitVec=i.pos.clone(),a.game.controller.attackEntity(i),r&&this.block())}),e||r&&this.unblock()}};var y=class extends l{constructor(){super("ChatBypass","Misc")}onPacket(e){e.name=="SPacketMessage"&&(e.data.text=e.data.text.split(" ").map(t=>`${t.charAt(0)}\\${t.slice(1)}`).join(" "))}};var k=class extends l{constructor(){super("NoFall","Misc")}afterTick(){a.game.player.motion.y<-.5&&!a.game.player.jumping&&(a.game.player.onGround=!0,a.game.player.sendPositionAndRotation(),a.game.player.onGround=!1)}};var w=class extends l{constructor(){super("PacketLogger","Misc",{})}trimName(e){return e.substring(0,15)}onPacket(e){let t=this.trimName(e.name);this.options[t]||(this.options[t]="true",b.modules.ClickGUI.panels.find(r=>r.title==this.category).refreshModuleSettings()),this.options[t]=="true"&&console.log(e.name,e.data)}};var v=class extends l{constructor(){super("SelfHarm","Misc")}onEnable(){a.game.controller.objectMouseOver.hitVec=a.game.player.pos.clone(),a.game.controller.attackEntity(a.game.player),this.disable()}};var E=class extends l{constructor(){super("Airjump","Movement",null)}beforeTick(){a.game.player.jumping&&(a.game.player.onGround=!0)}};var C=class extends l{constructor(){super("HighJump","Movement",{"Jump Velocity":.6})}onEnable(){a.game.player.initialJumpVelocity=parseFloat(this.options["Jump Velocity"])}onDisable(){a.game.player.initialJumpVelocity=.42}};var h={fromBlockStateId(o){let e=a.game.world.chunkProvider.posToChunk.values().next().value.constructor,t=null;return e.prototype.setBlockState.bind({getBlockState:function(){return{equals:function(r){return t=r,!0}}}})(0,o),t},get BlockPos(){if(this._cBlockPos)return this._cBlockPos;let o={};return a.game.world.setAirXYZ.bind({setBlockState:function(e){o=e}})(0,0,0),this._cBlockPos=o.constructor,this._cBlockPos}};var N=34,W=1,B=class extends l{constructor(){super("Jesus","Movement",null)}onEnable(){let e=h.fromBlockStateId(N).manager,t=h.fromBlockStateId(W).manager.block.constructor;this.waterBlock||(this.waterBlock=e.block),e.block=new t,e.block.id=N,e.block.isReplaceable=!0,e.block.transparent=!0,e.block.fullBlock=!1}onDisable(){let e=h.fromBlockStateId(N).manager;e.block=this.waterBlock}};var S=class extends l{constructor(){super("Phase","Movement",null)}onEnable(){a.game.player.height=0}onDisable(){a.game.player.height=1.8}};var F={placeBlock(o,e,t){a.game.controller.onPlayerRightClick({sneak:!1,getActiveItemStack:()=>null,mode:{isSpectator:()=>!1}},{getBlockState:function(){return{getBlock:function(){return{onBlockActivated:function(){}}}}}},{item:{canPlaceBlockOnSide:()=>!1,isItemBlock:()=>!0}},o,{toProto:()=>e},t)}};var T=class extends l{constructor(){super("Scaffold","Movement",{"Client Place":!0,Extend:3})}tryPlace(e,t,r){let i=a.game.player.inventory.getCurrentItem()?.item?.block?.defaultState,n=new h.BlockPos(e,t,r);a.game.world.getBlockState(n)?.id===0&&(this.options["Client Place"]&&a.game.world.setBlockState(n,i),F.placeBlock(n,1,{x:0,y:0,z:0}))}afterTick(){if(!a.game.player.inventory.getCurrentItem()?.item?.block?.defaultState)return;let t=a.game.player.pos.clone().floor(),r=a.game.player.yaw,i=-Math.sin(r),n=-Math.cos(r);if(this.tryPlace(t.x,t.y-1,t.z),!a.game.player.onGround)return;let c=parseInt(this.options.Extend);for(let s=1;s<=c;s++){let u=Math.floor(t.x+i*s+.5),g=t.y-1,m=Math.floor(t.z+n*s+.5);this.tryPlace(u,g,m)}}};var P=class extends l{constructor(){super("Speed","Movement",{"Air Speed":.03})}onEnable(){a.game.player.speedInAir=parseFloat(this.options["Air Speed"])}onDisable(){a.game.player.speedInAir=.02}};var M=class extends l{constructor(){super("Spider","Movement",{"Climb Speed":.2})}afterTick(){a.game.player.isCollidedHorizontally&&(a.game.player.motion.y=parseFloat(this.options["Climb Speed"]))}};var A=class extends l{constructor(){super("Step","Movement",{Height:2})}onEnable(){a.game.player.stepHeight=parseFloat(this.options.Height)}onDisable(){a.game.player.stepHeight=.6}};var f={parseRGBString(o){let e=o.replaceAll("rgb","").replaceAll("a","").replaceAll("(","").replaceAll(")","").replaceAll(" ","").split(",");return{r:parseFloat(e?.[0]||1),g:parseFloat(e?.[1]||1),b:parseFloat(e?.[2]||1),a:parseFloat(e?.[3]||1)}},normalizeColor(o){return o?o.r<=1&&o.g<=1&&o.b<=1?o:{r:o.r/255,g:o.g/255,b:o.b/255}:{r:1,g:1,b:1}},hexToRGBA(o,e=1,t=1){let r=o.startsWith("#")?o.substring(1):o;r.length===3&&(r=r.split("").map(s=>s+s).join(""));let i=parseInt(r.substring(0,2),16)*t,n=parseInt(r.substring(2,4),16)*t,c=parseInt(r.substring(4,6),16)*t;return`rgba(${Math.round(i)}, ${Math.round(n)}, ${Math.round(c)}, ${e})`},hexToRgb(o){var e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(o);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null}};var d={instance:null,get wrapper(){if(!this.instance){let o=document.createElement("iframe");document.body.appendChild(o);let e=o.contentWindow.Element.prototype.attachShadow;o.remove();let t=document.createElement("div");this.root=e.apply(t,[{mode:"closed"}]);let r=document.createElement("div");this.root.appendChild(r),this.instance=r,document.body.appendChild(t)}return this.instance}};var O=class extends l{constructor(){super("Arraylist","Visual",{Opacity:1,"Background Opacity":.1,"Darkness Multiplier":.3,"Accent Darkness":.5,Blur:1}),this.namesMap={},this.arraylistContainer=null,this.initialized=!1}getAccentColors(){let e=getComputedStyle(d.wrapper);return["--Ballcrack-accent-color-1","--Ballcrack-accent-color-2"].map(t=>e.getPropertyValue(t).trim())}update(e,t){if(t){if(!this.namesMap[e]){let i=document.createElement("div"),n=this.getAccentColors(),c=parseFloat(this.options["Background Opacity"]),s=parseFloat(this.options["Darkness Multiplier"]),u=parseFloat(this.options["Accent Darkness"]),g=parseFloat(this.options.Blur);i.style.background=`linear-gradient(to right, ${f.hexToRGBA(n[0],c,u)}, ${f.hexToRGBA(n[1],c+.2,u+.2)})`,i.style.backdropFilter=`blur(${g}px) brightness(${s})`,i.style.color="white",i.style.padding="2px 10px",i.style.display="flex",i.style.alignItems="center",i.style.boxSizing="border-box",i.style.margin="0",i.style.lineHeight="1",i.style.gap="0",i.style.fontFamily="'Product Sans', sans-serif",i.style.boxShadow="rgb(0, 0, 0, 0.05) -5px 1px",i.style.transition="opacity 0.2s ease-in-out, max-height 0.2s ease-in-out",i.style.overflow="hidden",i.style.maxHeight="0",i.style.opacity=parseFloat(this.options.Opacity);let m=document.createElement("span");m.style.fontWeight="800",m.style.fontSize="16px",m.style.backgroundImage="var(--Ballcrack-accent-color)",m.style.color="transparent",m.style.backgroundClip="text",m.style.webkitBackgroundClip="text",m.innerHTML=e,i.appendChild(m),this.arraylistContainer.appendChild(i),setTimeout(()=>{i.style.maxHeight="50px",i.style.opacity="1"},1),this.namesMap[e]=i}}else if(this.namesMap[e]){let i=this.namesMap[e];i.style.maxHeight="0",i.style.opacity="0",setTimeout(()=>{this.arraylistContainer.contains(i)&&this.arraylistContainer.removeChild(i),delete this.namesMap[e]},200)}let r=Object.values(this.namesMap).sort((i,n)=>this.measureElementWidth(n)-this.measureElementWidth(i));this.arraylistContainer.innerHTML="",r.forEach(i=>this.arraylistContainer.appendChild(i))}onEnable(){this.initialized?this.arraylistContainer.style.opacity="1":(this.arraylistContainer=document.createElement("div"),this.arraylistContainer.style.flexDirection="column",this.arraylistContainer.style.display="flex",this.arraylistContainer.style.gap="0",this.arraylistContainer.style.lineHeight="0",this.arraylistContainer.style.position="absolute",this.arraylistContainer.style.zIndex="99999",this.arraylistContainer.style.right="5px",this.arraylistContainer.style.top="5px",this.arraylistContainer.style.alignItems="flex-end",this.arraylistContainer.style.pointerEvents="none",this.arraylistContainer.style.textTransform="lowercase",this.arraylistContainer.style.border="2px solid transparent",this.arraylistContainer.style.borderImage="var(--Ballcrack-accent-color)",this.arraylistContainer.style.borderImageSlice="1",this.arraylistContainer.style.borderBottom="0",this.arraylistContainer.style.borderLeft="0",d.wrapper.appendChild(this.arraylistContainer),p.on("module.update",e=>{this.update(e.name,e.isEnabled)}),this.initialized=!0)}onSettingUpdate(e){if(e=="ClickGUI"||e=="Arraylist"){let t=this.getAccentColors(),r=parseFloat(this.options["Background Opacity"]),i=parseFloat(this.options["Darkness Multiplier"]),n=parseFloat(this.options["Accent Darkness"]),c=parseFloat(this.options.Blur);Object.values(this.namesMap).forEach(s=>{s.style.background=`linear-gradient(to right, ${f.hexToRGBA(t[0],r,n)}, ${f.hexToRGBA(t[1],r+.2,n+.2)})`,s.style.backdropFilter=`blur(${c}px) brightness(${i})`,s.style.opacity=parseFloat(this.options.Opacity)})}}measureElementWidth(e){return e.getBoundingClientRect().width}onDisable(){this.arraylistContainer.style.opacity="0"}};var I=class extends l{constructor(){super("Chams","Visual","")}onEnable(){let e=a.game.player.mesh.constructor.prototype;this._renderPlayers=this.__renderPlayers||e.render;let t=this;e.render=function(){for(let r in this.meshes)this.meshes[r].material.depthTest=!1,this.meshes[r].renderOrder=3;for(let r in this.armorMesh)this.armorMesh[r].material.depthTest=!1,this.armorMesh[r].renderOrder=4;if(this.capeMesh&&(this.capeMesh.children[0].material.depthTest=!1,this.capeMesh.children[0].renderOrder=5),this.hatMesh)for(let r of this.hatMesh.children[0].children)r.material&&(r.material.depthTest=!1,r.renderOrder=4);return t._renderPlayers.apply(this,arguments)}}onDisable(){let e=a.game.player.mesh.constructor.prototype;e.render=this._renderPlayers}};var D=class{constructor(e,t){this.module=e,this.container=t,this.components=[],this.renderedOptions=new Set,this.initialized=!1,this.isOpen=!1,this.activeDropdown=null,this.currentOptionsList=null,this.activeDropdownListeners=null}initialize(){if(this.initialized||!this.module?.options)return;this.settingsWrapper=document.createElement("div"),this.settingsWrapper.className="module-settings-wrapper",this.container.appendChild(this.settingsWrapper),this.settingsContainer=document.createElement("div"),this.settingsContainer.className="module-settings scrollable",this.settingsWrapper.appendChild(this.settingsContainer),this.container.style.position="relative";let e=Object.keys(this.module.options),t=this.groupSettings(e);this.createSettings(t),this.initialized=!0}groupSettings(e){return e.reduce((t,r)=>{let i=this.module.options[r],n=typeof i;return r.toLowerCase().includes("color")?t.color.push(r):this.module.modes&&this.module.modes[r]?t.mode.push(r):n==="boolean"||i==="true"||i==="false"?t.boolean.push(r):t.other.push(r),t},{boolean:[],mode:[],other:[],color:[]})}createSettings(e){[...e.boolean,...e.mode,...e.other,...e.color].forEach(t=>{if(this.renderedOptions.has(t))return;this.renderedOptions.add(t);let r=this.module.options[t],i=typeof r;t.toLowerCase().includes("color")?this.addColorPicker(t):this.module.modes&&this.module.modes[t]?this.addModeSelector(t):i==="boolean"||r==="true"||r==="false"?this.addCheckbox(t):i==="string"?this.addStringInput(t):this.addNumberInput(t)})}toggle(){this.isOpen=!this.isOpen,this.isOpen?(this.settingsWrapper.classList.add("module-settings-open"),this.checkPositionWithinViewport()):(this.settingsWrapper.classList.remove("module-settings-open"),this.closeAllDropdowns())}checkPositionWithinViewport(){let e=this.settingsWrapper.getBoundingClientRect();if(e.bottom>window.innerHeight){let t=e.bottom-window.innerHeight;this.settingsWrapper.style.maxHeight=`${e.height-t-10}px`}}closeAllDropdowns(){document.querySelectorAll(".gui-dropdown-options").forEach(e=>{d.wrapper.contains(e)&&d.wrapper.removeChild(e)}),this.activeDropdownListeners&&(document.removeEventListener("click",this.activeDropdownListeners.outsideClickHandler),window.removeEventListener("scroll",this.activeDropdownListeners.hideDropdown,!0),window.removeEventListener("resize",this.activeDropdownListeners.hideDropdown,!0),this.activeDropdownListeners=null),this.activeDropdown&&(this.activeDropdown.classList.remove("open"),this.activeDropdown=null),this.currentOptionsList=null}addNumberInput(e){let t=document.createElement("div");t.className="gui-setting-container setting-number";let r=document.createElement("div");r.className="gui-setting-label",r.textContent=e;let i=document.createElement("input");i.type="text",i.className="gui-text-input number-input",i.value=this.module.options[e],i.addEventListener("input",()=>{let n=i.value.trim();!isNaN(n)&&n!==""&&(this.module.options[e]=n,p.emit("setting.update",{moduleName:this.module.name,setting:e,value:n}))}),t.append(r,i),this.settingsContainer.appendChild(t),this.components.push(t)}addStringInput(e){let t=document.createElement("div");t.className="gui-setting-container setting-string";let r=document.createElement("div");r.className="gui-setting-label",r.textContent=e;let i=document.createElement("input");i.type="text",i.className="gui-text-input string-input",i.value=this.module.options[e],i.addEventListener("input",()=>{this.module.options[e]=i.value,p.emit("setting.update",{moduleName:this.module.name,setting:e,value:i.value})}),t.append(r,i),this.settingsContainer.appendChild(t),this.components.push(t)}addCheckbox(e){let t=document.createElement("div");t.className="gui-setting-container setting-boolean";let r=document.createElement("div");r.className="gui-setting-label",r.textContent=e;let i=document.createElement("div");i.className="gui-checkbox",i.classList.toggle("enabled",this.module.options[e]===!0||this.module.options[e]==="true"),t.addEventListener("click",()=>{let n=!(this.module.options[e]===!0||this.module.options[e]==="true");this.module.options[e]=n.toString(),i.classList.toggle("enabled",n),p.emit("setting.update",{moduleName:this.module.name,setting:e,value:n.toString()})}),t.append(r,i),this.settingsContainer.appendChild(t),this.components.push(t)}addColorPicker(e){let t=document.createElement("div");t.className="gui-setting-container setting-color";let r=document.createElement("div");r.className="gui-setting-label",r.textContent=e;let i=document.createElement("div");i.className="gui-color-picker",i.style.background=this.module.options[e];let n=document.createElement("input");n.type="color",n.value=this.rgbToHex(this.module.options[e]),n.addEventListener("input",c=>{i.style.background=c.target.value,this.module.options[e]=c.target.value,p.emit("setting.update",{moduleName:this.module.name,setting:e,value:c.target.value})}),i.appendChild(n),t.append(r,i),this.settingsContainer.appendChild(t),this.components.push(t)}addModeSelector(e){let t=document.createElement("div");t.className="gui-setting-container setting-mode";let r=document.createElement("div");r.className="gui-setting-label",r.textContent=e;let i=document.createElement("div");i.className="gui-dropdown";let n=document.createElement("div");n.className="gui-dropdown-selected",n.textContent=this.module.options[e],i.appendChild(n),i.addEventListener("click",c=>{c.stopPropagation(),this.closeAllDropdowns();let s=document.createElement("div");s.className="gui-dropdown-options",this.module.modes[e].forEach(u=>{let g=document.createElement("div");g.textContent=u,g.addEventListener("click",()=>{this.module.options[e]=u,n.textContent=u,p.emit("setting.update",{moduleName:this.module.name,setting:e,value:u}),this.closeAllDropdowns()}),s.appendChild(g)}),d.wrapper.appendChild(s),this.currentOptionsList=s,this.activeDropdown=i}),t.append(r,i),this.settingsContainer.appendChild(t),this.components.push(t)}refresh(){if(!this.initialized)return;let e=Object.keys(this.module.options).filter(t=>!this.renderedOptions.has(t));if(e.length){let t=this.groupSettings(e);this.createSettings(t)}for(let t of this.components){let r=t.querySelector(".gui-setting-label")?.textContent;if(!(r in this.module.options))continue;let i=this.module.options[r],n=t.querySelector(".gui-checkbox");if(n){n.classList.toggle("enabled",i===!0||i==="true");continue}let c=t.querySelector(".gui-dropdown-selected");if(c){c.textContent=i;continue}let s=t.querySelector("input");if(s){s.value=i;continue}let u=t.querySelector(".gui-color-picker");u&&(u.style.background=i)}}rgbToHex(e){if(!e)return"#000000";if(e.startsWith("#"))return e;let t=e.match(/(\d+),\s*(\d+),\s*(\d+)/);return t?"#"+((1<<24)+(+t[1]<<16)+(+t[2]<<8)+ +t[3]).toString(16).slice(1):"#000000"}};var L=class{constructor(e,t={top:"200px",left:"200px"}){this.title=e,this.panel=document.createElement("div"),this.panel.className="gui-panel",this.panel.style.top=t.top,this.panel.style.left=t.left,this.header=document.createElement("div"),this.header.className="gui-header",this.header.textContent=e,this.panel.appendChild(this.header),d.wrapper.appendChild(this.panel),this.buttons=[],this.settings=[],this.setupDragHandling()}setupDragHandling(){let e=!1,t={x:0,y:0};this.header.addEventListener("mousedown",r=>{e=!0,t.x=r.clientX-this.panel.offsetLeft,t.y=r.clientY-this.panel.offsetTop}),document.addEventListener("mousemove",r=>{e&&(this.panel.style.left=r.clientX-t.x+"px",this.panel.style.top=r.clientY-t.y+"px")}),document.addEventListener("mouseup",()=>e=!1)}addButton(e){let t=document.createElement("div");t.className="gui-button-container";let r=document.createElement("div");r.className=`gui-button ${e.isEnabled?"enabled":""}`,r.textContent=e.name;let i=new D(e,t);return this.settings.push(i),r.addEventListener("mousedown",n=>{n.button===0&&(e.toggle(),r.classList.toggle("enabled",e.isEnabled)),n.button===1&&(r.textContent="waiting for bind..",e.waitingForBind=!0)}),r.addEventListener("contextmenu",n=>{n.preventDefault(),i.initialize(),i.toggle()}),r.setAttribute("tabindex",-1),r.addEventListener("keydown",n=>{r.textContent=e.name,e.waitingForBind&&(n.preventDefault(),n.stopPropagation(),n.stopImmediatePropagation(),e.keybind=n.key==="Escape"?null:String(n.code),e.waitingForBind=!1)}),t.appendChild(r),this.panel.appendChild(t),this.buttons.push(r),r}refreshModuleSettings(){for(let e of this.settings)typeof e.refresh=="function"&&e.refresh()}show(){this.panel.style.display="block"}hide(){this.panel.style.display="none"}};var z=class extends l{constructor(){super("ClickGUI","Visual",{"Accent Color 1":"#40beffff","Accent Color 2":"#81e1ffff","Button Color":"rgb(40, 40, 40, 0.9)","Hover Color":"rgb(50, 50, 50, 0.9)","Header Color":"rgb(0, 0, 0, 0.85)","Panel Color":"rgb(18 18 18)","Text Color":"#ffffff","Glow Alpha":"0.8","Enable Animations":!0},"ShiftRight"),this.GUILoaded=!1,this.panels=[],this.blurredBackground=null,this.updateColors()}updateAnimations(){this.options["Enable Animations"]?d.wrapper.classList.add("with-animations"):d.wrapper.classList.remove("with-animations")}updateColors(){let e=`linear-gradient(90deg, ${this.options["Accent Color 1"]} 0%, ${this.options["Accent Color 2"]} 100%)`;d.wrapper.style.setProperty("--Ballcrack-accent-color",e),d.wrapper.style.setProperty("--Ballcrack-accent-color",e),d.wrapper.style.setProperty("--Ballcrack-accent-color-1",this.options["Accent Color 1"]),d.wrapper.style.setProperty("--Ballcrack-accent-color-2",this.options["Accent Color 2"]),d.wrapper.style.setProperty("--Ballcrack-button-color",this.options["Button Color"]),d.wrapper.style.setProperty("--button-color",this.options["Button Color"]),d.wrapper.style.setProperty("--hover-color",this.options["Hover Color"]),d.wrapper.style.setProperty("--header-bg",this.options["Header Color"]),d.wrapper.style.setProperty("--panel-bg",this.options["Panel Color"]),d.wrapper.style.setProperty("--text-color",this.options["Text Color"]),d.wrapper.style.setProperty("--glow-color",f.hexToRGBA(this.options["Accent Color 1"],parseFloat(this.options["Glow Alpha"]),1.2))}onEnable(){document.pointerLockElement&&document.exitPointerLock(),this.GUILoaded?(this.showGUI(),this.updateAnimations()):(this.setupBackground(),this.createPanels(),this.setupEventListeners(),this.GUILoaded=!0,this.updateAnimations())}setupBackground(){this.blurredBackground=document.createElement("div"),this.blurredBackground.className="gui-background",d.wrapper.appendChild(this.blurredBackground)}createPanels(){let e=[{title:"Combat",position:{top:"100px",left:"100px"}},{title:"Movement",position:{top:"100px",left:"338px"}},{title:"Visual",position:{top:"100px",left:"576px"}},{title:"World",position:{top:"100px",left:"814px"}},{title:"Misc",position:{top:"100px",left:"1052px"}}];this.panels.forEach(r=>{r.panel&&r.panel.parentNode&&r.panel.parentNode.removeChild(r.panel)}),this.panels=[],e.forEach(r=>{let i=new L(r.title,r.position);this.panels.push(i)});let t={};Object.values(b.modules).forEach(r=>{t[r.category]||(t[r.category]=[]),t[r.category].push(r)}),Object.entries(t).forEach(([r,i])=>{let n=this.panels.find(s=>s.header.textContent===r);if(!n)return;let c=document.createElement("span");c.style.visibility="hidden",c.style.position="absolute",c.style.font="'Product Sans', sans-serif",d.wrapper.appendChild(c),i.sort((s,u)=>{c.textContent=s.name;let g=c.getBoundingClientRect().width;return c.textContent=u.name,c.getBoundingClientRect().width-g}),c.remove(),i.forEach(s=>n.addButton(s))})}setupEventListeners(){p.on("module.update",e=>{let t=this.panels.find(i=>i.header.textContent===e.category);if(!t)return;let r=t.buttons.find(i=>i.textContent===e.name);r&&r.classList.toggle("enabled",e.isEnabled)})}showGUI(){this.panels.forEach(e=>e.show()),this.blurredBackground.style.display="block"}returnToGame(){}onDisable(){this.panels.forEach(e=>e.hide()),this.blurredBackground.style.display="none",this.returnToGame()}onSettingUpdate(){this.updateColors(),this.updateAnimations()}};var _=class extends l{constructor(){super("Watermark","Visual",{Text:"Ballcrack"},""),this.watermarkElement=null,this.mainText=null}onSettingUpdate(){this.mainText&&(this.mainText.textContent=this.options.Text)}onEnable(){if(!this.watermarkElement){let e=document.createElement("div");e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.padding="0.5em",e.style.userSelect="none",e.style.display="flex",e.style.zIndex="999999",e.style.fontFamily="'Product Sans', sans-serif",e.style.fontSize="24px",e.style.backgroundClip="text",e.style.webkitFontSmoothing="antialiased",e.style.webkitTextFillColor="transparent",e.style.textShadow="var(--Ballcrack-accent-color) 0px 0px 10px",e.style.background="var(--Ballcrack-accent-color)",e.style.backgroundClip="text",this.mainText=document.createElement("span"),this.mainText.textContent="Ballcrack";let t=document.createElement("span");t.textContent="v1",t.style.fontSize="14px",t.style.paddingBottom="15px",t.style.marginLeft="4px",t.style.alignSelf="flex-end",e.appendChild(this.mainText),e.appendChild(t),d.wrapper.appendChild(e),this.watermarkElement=e}this.watermarkElement.style.display="flex"}onDisable(){this.watermarkElement.style.display="none"}};var b={modules:{},addModules:function(...o){for(let e of o){let t=new e;this.modules[t.name]=t}},addModule:function(o){this.modules[o.name]=o},handleKeyPress:function(o){for(let e in this.modules){let t=this.modules[e];t.waitingForBind?(t.keybind=o,t.waitingForBind=!1):o&&t.keybind==o&&t.toggle()}},init(){this.addModules(_,z,O,I,E,S,A,C,P,T,M,B,x,v,k,y,w),p.on("render",()=>{for(let o in this.modules)this.modules[o].isEnabled&&this.modules[o].onRender()}),p.on("beforeTick",()=>{for(let o in this.modules)this.modules[o].isEnabled&&this.modules[o].beforeTick()}),p.on("afterTick",()=>{for(let o in this.modules)this.modules[o].isEnabled&&this.modules[o].afterTick()}),p.on("packet",o=>{for(let e in this.modules)this.modules[e].isEnabled&&this.modules[e].onPacket(o)}),p.on("keydown",this.handleKeyPress.bind(this)),p.on("setting.update",o=>{for(let e in this.modules)(this.modules[e].isEnabled||o.moduleName===e)&&this.modules[e].onSettingUpdate(o.moduleName,o.setting,o.value)}),this.modules.Arraylist.enable(),this.modules.Watermark.enable()}};var H=`:host {\r
...
.gui-button-container {\r
    user-select: none;\r
}`;var R={init(){let o=a.game.player.inventory.sendInventoryToServer();this.$Message2=o.constructor.__proto__,this.proto2=o.constructor.runtime,this._toJson=this.$Message2.prototype.toJson;let e=this;this.$Message2.prototype.toJson=function(){let t=e._toJson.apply(this,arguments),r=this.getType().typeName;return p.emit("packet",{name:r,data:t}),t},this.PBFloatVector3=this.createPacket("PBFloatVector3",this.fields.PBFloatVector3),this.PBBlockPos=this.createPacket("PBBlockPos",this.fields.PBBlockPos),this.PBAction={0:"START_DESTROY_BLOCK",1:"ABORT_DESTROY_BLOCK",2:"STOP_DESTROY_BLOCK",3:"DROP_ALL_ITEMS",4:"DROP_ITEM",5:"RELEASE_USE_ITEM",START_DESTROY_BLOCK:0,ABORT_DESTROY_BLOCK:1,STOP_DESTROY_BLOCK:2,DROP_ALL_ITEMS:3,DROP_ITEM:4,RELEASE_USE_ITEM:5},this.proto2.util.setEnumType(this.PBAction,"PBAction",[{no:0,name:"START_DESTROY_BLOCK"},{no:1,name:"ABORT_DESTROY_BLOCK"},{no:2,name:"STOP_DESTROY_BLOCK"},{no:3,name:"DROP_ALL_ITEMS"},{no:4,name:"DROP_ITEM"},{no:5,name:"RELEASE_USE_ITEM"}]),this.PBEnumFacing={0:"UNDEFINED_FACE",1:"DOWN",2:"UP",3:"NORTH",4:"SOUTH",5:"WEST",6:"EAST",UNDEFINED_FACE:0,DOWN:1,UP:2,NORTH:3,SOUTH:4,WEST:5,EAST:6},this.proto2.util.setEnumType(this.PBEnumFacing,"PBEnumFacing",[{no:0,name:"UNDEFINED_FACE"},{no:1,name:"DOWN"},{no:2,name:"UP"},{no:3,name:"NORTH"},{no:4,name:"SOUTH"},{no:5,name:"WEST"},{no:6,name:"EAST"}])},createPacket(o,e=[],t={}){let r=this.$Message2,i=this.proto2,n=class extends r{constructor(s){super(),i.util.initPartial(s,this)}static fromBinary(s,u){return new n().fromBinary(s,u)}static fromJson(s,u){return new n().fromJson(s,u)}static fromJsonString(s,u){return new n().fromJsonString(s,u)}static equals(s,u){return i.util.equals(n,s,u)}};n.typeName=o,n.runtime=i,n.fields=i.util.newFieldList(()=>e);let c=new n;for(let s in t)c[s]=t[s];return c},sendPacket(o){let e=a.game.player,t=e.inventory.sendInventoryToServer,r=e.abilities.creative,i=e.inventory.main[e.inventory.currentItem];e.abilities.creative=!0,e.inventory.sendInventoryToServer=()=>o;try{a.game.controller.pickBlock.bind({getTargetedBlockState:function(){return h.fromBlockStateId(1)},findHotbarSlotForPickBlock:function(){return e.inventory.currentItem}})()}catch{}e.inventory.main[e.inventory.currentItem]=i,e.inventory.sendInventoryToServer=t,e.abilities.creative=r},fields:{PBFloatVector3:[{no:1,name:"x",kind:"scalar",T:2},{no:2,name:"y",kind:"scalar",T:2},{no:3,name:"z",kind:"scalar",T:2}],PBBlockPos:[{no:1,name:"x",kind:"scalar",T:17},{no:2,name:"y",kind:"scalar",T:17},{no:3,name:"z",kind:"scalar",T:17}]}};function G(o){let e=document.createElement("style");e.textContent=o,d.wrapper.appendChild(e)}var $=new FontFace("Product Sans","url(https://fonts.gstatic.com/s/productsans/v19/pxiDypQkot1TnFhsFMOfGShVF9eO.woff2)",{style:"normal",weight:"400"});$.load().then(o=>document.fonts.add(o));var K=new FontFace("Inter","url(https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_fvQtMwCp50KnMa.woff2)",{style:"normal",weight:"300"});K.load().then(o=>document.fonts.add(o));G(H);b.init();a.hookOnTick();R.init();document.addEventListener("keydown",o=>{p.emit("keydown",o.code)});setInterval(()=>{p.emit("render")},1e3/60);var V=!0;V&&(window.ballcrack={hooks:a,shadowWrapper:d,moduleManager:b,interactionUtils:F,blockUtils:h,packetUtils:R});})();
